<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="cateName" label="分类名称" width="260"></el-table-column>
        ...
        <el-row>
          <el-col :span="24" v-if="form.parentId !== 0">
            <el-form-item label="上级分类" prop="parentId">
              <treeselect v-model="form.parentId" :options="cateOptions" :normalizer="normalizer" placeholder="选择上级分类" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getCategory(row.cateId).then(response => {
        ...
        this.open = true;
        this.title = "修改分类";
        listCategoryExcludeChild(row.cateId).then(response => {
