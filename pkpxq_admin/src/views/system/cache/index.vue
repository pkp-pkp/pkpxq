            ...
            <el-row :gutter="32">
              ...
              <el-col :offset="1" :span="22">
                <el-form-item label="缓存内容:" prop="cacheValue">
                  <el-button @click="openJsonDetail(cacheForm.cacheValue)">查看内容</el-button>
                </el-form-item>
              </el-col>
            </el-row>
          </el-form>
...
<script>
import { listCacheName, listCacheKey, getCacheValue, clearCacheName, clearCacheKey } from "@/api/system/cache";
export default {
  name: "CacheList",
  data() {
    return {
