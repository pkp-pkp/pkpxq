...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const { list, loadStatus, getFansList, resetList } = hooks_useUserList.useUserList();
    common_vendor.onLoad((options) => {
      let { userId: id } = options;
      userId.value = id;
      getFansList({ userId: userId.value });
    });
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/潘坤鹏/Desktop/school-wx/pages/user/fans.vue"]]);
